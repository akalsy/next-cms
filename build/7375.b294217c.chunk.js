"use strict";
(self["webpackChunknextjs_cms"] = self["webpackChunknextjs_cms"] || []).push([[7375],{
...
const schema = yup_lib/* object */.Ry().shape({
  ...
  lifespan: yup_lib/* number */.Rx().integer().min(1).nullable().defined(build.translatedErrors.required)
});
...
Regenerate.propTypes = {
  ...
  idToRegenerate: (prop_types_default()).string.isRequired
};
  ...
  const handleSubmit = (body, actions) => EditView_async(void 0, null, function* () {
    ...
    try {
      const {
        ...
        lifespan: body.lifespan && parseInt(body.lifespan, 10) ? parseInt(body.lifespan, 10) : body.lifespan,
